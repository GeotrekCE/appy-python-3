...
class Calendar(Field):
    ...
    def __init__(self, eventTypes=None, eventNameMethod=None,
      ...
      others=None, timelineName=None, additionalInfo=None, startDate=None,
      endDate=None, defaultDate=None, timeslots=None, colors=None,
      showUncolored=False, columnColors=None, preCompute=None,
      applicableEvents=None, totalRows=None, totalCols=None, validation=None,
      layers=None, layersSelector=True, topPx=None, bottomPx=None, actions=None,
      selectableEmptyCells=False, legend=None, view=None, cell=None, edit=None,
    ...
    def deleteEvent(self, obj, date, timeslot, handleEventSpan=True,
        ...
        if timeslot == 'main':
            ...
            rq = obj.REQUEST
            suffix = ''
            if handleEventSpan and (rq.deleteNext == 'True'):
                nbOfDays = 0
                while True:
                    date = date + 1
