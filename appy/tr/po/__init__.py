...
class Message:
    ...
    def get(self):
        ...
        # "\n" and will replace them with a double XHTML carriage return
        # "<br/><br/>". Moreover, because double quotes escaping is required due
        # to the format of "po" files, we perform such escaping too.
