...
from appy.xml import xmlPrologue, Escape
...
class Buffer:
    ...
    def patchElement(self, elem, attrs):
        ...
        elif self.env.parser.caller.protection and \
             (elem in ('table:table-cell', 'text:section')):
            # Add or patch the attribute allowing to protect the cell or
    ...
    def dumpContent(self, content):
        ...
        content = Escape.xml(content, flavour=self.pod and 'odf' or 'xml')
        self.write(content)
